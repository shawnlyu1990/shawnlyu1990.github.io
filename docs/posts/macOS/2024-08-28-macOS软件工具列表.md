...
- **费用**：<Badge text="收费" type="danger" vertical="baseline" />
    我是在 iPhone 上订阅的，¥26/月（之前是 ¥28，后来降了 2 块）。官网上看，个人版是 $2.99/月，家庭版 $4.99/月。
...
- **费用**：<Badge text="免费" type="tip" vertical="baseline" /> + <Badge text="收费" type="danger" vertical="baseline" />
    基础功能免费，高级功能收费，高级功能（Cubox Pro） ¥98/年，增加 AI 功能的话是 ¥198/年。
...
- **费用**：<Badge text="收费" type="danger" vertical="baseline" />
    官网售价 ¥199，<font color="darkred">**一次购买，终身更新使用**</font>。一个序列号可以绑定 2 台设备。
...
- **费用**：<Badge text="免费" type="tip" vertical="baseline" /> + <Badge text="收费" type="danger" vertical="baseline" />
    ...
    - **FileZilla Pro Client <Badge text="收费" type="danger" vertical="top" />**，7 天免费试用，试用期过后，收取 $9.99/年，官网价格是 €19.99（可能是买断价格）。除了支持 FTP、FTP over TLS (FTPS) 、SFTP 以外，还支持 WebDAV、Amazon S3、Backblaze B2、Dropbox、Microsoft OneDrive、Google Drive、Microsoft Azure Blob and File Storage、Google Cloud Storage.
