import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as r,d as t,a as n,e as a,b as p,w as l,r as o,o as d}from"./app-BICfmULO.js";const c="/assets/postsimages/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F/QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.jpeg",u={};function g(m,s){const e=o("font");return d(),r("div",null,[s[30]||(s[30]=t('<div class="hint-container important"><p class="hint-container-title">转载声明</p><p>以下内容转载自：<a href="https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e" target="_blank" rel="noopener noreferrer">https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e</a></p></div><p>QinQ 是对 802.1Q（VLAN） 的扩展，其核心思想是将用户私网 VLAN tag 封装到公网 VLAN tag 中，报文带着两层 tag 穿越服务商的骨干网络，从而为用户提供一种较为简单的二层 VPN 隧道。QinQ 报文有固定的格式，就是在 802.1Q 的标签之上再打一层 802.1Q 标签，QinQ 报文比 802.1Q（VLAN） 报文多 4 字节。</p><h2 id="帧格式" tabindex="-1"><a class="header-anchor" href="#帧格式"><span>帧格式</span></a></h2><figure><img src="'+c+'" alt="QinQ 帧格式" tabindex="0" loading="lazy"><figcaption>QinQ 帧格式</figcaption></figure><p>QinQ帧的链路层各字段含义</p>',5)),n("table",null,[s[29]||(s[29]=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"center"}},[n("div",{style:{width:"80px"}},"字段")]),n("th",{style:{"text-align":"center"}},[n("div",{style:{width:"120px"}},"长度")]),n("th",null,"含义")])],-1)),n("tbody",null,[s[22]||(s[22]=n("tr",null,[n("td",{style:{"text-align":"center"}},"DMAC"),n("td",{style:{"text-align":"center"}},"6 字节"),n("td",null,"目的 MAC 地址，该字段标识帧的接收者。")],-1)),s[23]||(s[23]=n("tr",null,[n("td",{style:{"text-align":"center"}},"SMAC"),n("td",{style:{"text-align":"center"}},"6 字节"),n("td",null,"源 MAC 地址，该字段标识帧的发送者。")],-1)),s[24]||(s[24]=n("tr",null,[n("td",{style:{"text-align":"center"}},"TPID/ETPE"),n("td",{style:{"text-align":"center"}},"2 字节"),n("td",null,[a("TPID（Tag Protocol Identifier，标签协议标识）表示帧类型。取值为 0x8100时表示 802.1Q Tag 帧。如果不支持 802.1Q 的设备收到这样的帧，会将其丢弃。"),n("br"),a(),n("br"),a("对于内层的 802.1Q Tag，该值设置为 0x8100 ；对于外层的 802.1Q Tag，不同厂商所使用的值可能不相同："),n("li",null,"0x8100：Huawei路由器使用"),n("li",null,"0x88A8：Extreme Networks 交换机使用 (该值在IEEE 802.1ad定义.)"),n("li",null,"0x9100：Juniper路由器使用"),n("li",null,"0x9200：Several路由器使用"),n("br"),a(),n("br"),a("在使用VRP®（Versatile Routing Platform）软件的华为设备上，外层802.1Q Tag 缺省情况下值为 0x8100，可以通过命令行调整该值。")])],-1)),s[25]||(s[25]=n("tr",null,[n("td",{style:{"text-align":"center"}},"PRI"),n("td",{style:{"text-align":"center"}},"3 比特"),n("td",null,"PRI（Priority） 表示帧的 QoS 优先级，取值范围为 0～7，值越大优先级越高，该优先级主要为 QoS 差分服务提供参考依据。当阻塞时，优先发送优先级高的数据包。如果设置用户优先级，但是没有 VID（VLAN ID），则 VLAN ID 必须设置为 0x000。")],-1)),n("tr",null,[s[9]||(s[9]=n("td",{style:{"text-align":"center"}},"CFI/DEI",-1)),s[10]||(s[10]=n("td",{style:{"text-align":"center"}},"1 比特",-1)),n("td",null,[s[1]||(s[1]=a("CFI (Canonical Format Indicator，标准格式指示)，长度为 1 比特，表示MAC 地址是否是标准格式。CFI 为 0 说明是标准格式（以太网帧的 MAC 地址采用低字节在前），CFI 为 1 表示为非标准格式（非以太网帧的 MAC 地址采用高字节在前）。CFI 可用于区分以太网帧、FDDI（Fiber Distributed Digital Interface）帧和令牌环网帧。在以太网中，CFI 的值为 0。")),s[2]||(s[2]=n("br",null,null,-1)),s[3]||(s[3]=a()),s[4]||(s[4]=n("br",null,null,-1)),s[5]||(s[5]=a("DEI（Drop Eligible Indicator，丢弃优先级指示），配合 PRI 字段使用，共同指示帧的丢弃优先级，也就是系统发生了拥塞时，这些报文会被优先丢弃。")),s[6]||(s[6]=n("br",null,null,-1)),s[7]||(s[7]=a()),s[8]||(s[8]=n("br",null,null,-1)),p(e,{color:"darkred"},{default:l(()=>s[0]||(s[0]=[n("b",null,[a("说明："),n("br"),a(),n("br"),a("IEEE 802.1Q 定义了 CFI 字段，而 IEEE 802.1ad 标准重新定义了 CFI 字段，规定 S-Tag 里面的是 DEI，C-Tag 里面的是 CFI。"),n("br"),a(),n("br"),a("实际应用中，可以根据需要将此比特位用作 CFI 或者用作 DEI。")],-1)])),_:1})])]),s[26]||(s[26]=n("tr",null,[n("td",{style:{"text-align":"center"}},"VID"),n("td",{style:{"text-align":"center"}},"12 比特"),n("td",null,[a("VID（VLAN ID），长度为 12 比特，表示该帧所属的 VLAN。在 VRP 中，可配置的 VLAN ID 取值范围为 1～4094。协议规定 0 和 4095 为保留的 VLAN ID。"),n("br"),a(),n("br"),a("有三种 VID 类型："),n("li",null,"Untagged 帧：VID 不计"),n("li",null,"Priority-tagged 帧：VID 为 0x000"),n("li",null,"VLAN-tagged 帧：VID 范围 0～4095"),n("br"),a(),n("br"),a("三个特殊的 VID："),n("li",null,"0x000：设置优先级但无 VID"),n("li",null,"0x001：缺省 VID"),n("li",null,"0xFFF：预留 VID")])],-1)),s[27]||(s[27]=n("tr",null,[n("td",{style:{"text-align":"center"}},"Length/Type"),n("td",{style:{"text-align":"center"}},"2 字节"),n("td",null,[a("该字段有两种含义："),n("li",null,"Length：如果该字段值小于或等于十进制 1500（或十六进制0x05DC）时，该字段指后续数据的字节长度，但不包括 FCS 字段。"),n("li",null,"Type：如果该字段值大于或等于十进制 1536（或十六进制0x0600）时，该字段指链路直接封装的上层协议类型。")])],-1)),n("tr",null,[s[20]||(s[20]=n("td",{style:{"text-align":"center"}},"Data",-1)),s[21]||(s[21]=n("td",{style:{"text-align":"center"}},"38～1500 字节",-1)),n("td",null,[s[12]||(s[12]=a("负载（可能包含填充位）。")),s[13]||(s[13]=n("br",null,null,-1)),s[14]||(s[14]=a()),s[15]||(s[15]=n("br",null,null,-1)),s[16]||(s[16]=a("VLAN帧的长度必须为整数字节，因此帧的负载长度不足整数字节，需插入填充字段以保证数据帧的长度为整数字节。")),s[17]||(s[17]=n("br",null,null,-1)),s[18]||(s[18]=a()),s[19]||(s[19]=n("br",null,null,-1)),p(e,{color:"darkred"},{default:l(()=>s[11]||(s[11]=[n("b",null,[a("说明："),n("br"),a(),n("br"),a("IEEE 802.1Q 和 IEEE 802.1ad 标准中并没有定义 VLAN 帧的最小长度和最大长度。各厂商可能存在实现差异导致该字段长度不同。")],-1)])),_:1})])]),s[28]||(s[28]=n("tr",null,[n("td",{style:{"text-align":"center"}},"FCS"),n("td",{style:{"text-align":"center"}},"4 字节"),n("td",null,"帧校验序列 FCS（Frame Check Sequence） 是为接收网卡提供判断是否传输错误的一种方法，如果发现错误，丢弃此帧。FCS 只是通用叫法，具体的 FCS 还可以细分多种校验方法。在以太帧中，FCS 通常采用循环冗余码校验 CRC（Cyclical Redundancy Check）。")],-1))])]),s[31]||(s[31]=t(`<p>VLAN帧的物理层各字段含义</p><table><thead><tr><th style="text-align:center;"><div style="width:80px;">字段</div></th><th style="text-align:center;"><div style="width:120px;">长度</div></th><th>含义</th></tr></thead><tbody><tr><td style="text-align:center;">帧间隙</td><td style="text-align:center;">至少 12 字节</td><td>每个以太帧之间都要有帧间隙（Inter Frame Gap），即每发完一个帧后要等待一段时间才能再发另外一个帧，以便让帧接收者对接收的帧做必要的处理（如调整缓存的指针、更新计数、通知对报文进行处理等等）。<br> <br>在以太网标准中规定最小帧间隙是 12 个字节，其数据为全1。对于个别的接口，可减少到 64(GE) 或 40 比特 (10GE)，其他的接口都不应该小于 12 字节。</td></tr><tr><td style="text-align:center;">前同步码</td><td style="text-align:center;">7 字节</td><td>以太网标准中规定前导码为10101010 10101010 10101010 10101010 10101010 10101010 10101010（二进制），共7字节。</td></tr><tr><td style="text-align:center;">帧开始定界符</td><td style="text-align:center;">1 字节</td><td>以太网标准中规定帧开始定界符为 10101011（二进制），共1字节。</td></tr></tbody></table><h2 id="帧示例" tabindex="-1"><a class="header-anchor" href="#帧示例"><span>帧示例</span></a></h2><div class="language-text has-collapsed-lines collapsed" data-highlighter="shiki" data-ext="text" style="--vp-collapsed-lines:15;--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>Frame 1: 391 bytes on wire (3128 bits), 391 bytes captured (3128 bits)</span></span>
...
<span class="line"><span>    End Option</span></span></code></pre><div class="collapsed-lines"></div></div><h2 id="参考标准" tabindex="-1"><a class="header-anchor" href="#参考标准"><span>参考标准</span></a></h2><table><thead><tr><th><div style="width:120px;">标准</div></th><th>描述</th></tr></thead><tbody><tr><td><a href="https://tools.ietf.org/html/rfc3069" target="_blank" rel="noopener noreferrer">RFC 3069</a></td><td>VLAN Aggregation for Efficient IP Address Allocation</td></tr><tr><td><a href="http://standards.ieee.org/about/get/802/802.1.html" target="_blank" rel="noopener noreferrer">IEEE 802.1Q</a></td><td>IEEE Standards for Local and Metropolitan Area Networks : Virtual Bridged Local Area Networks</td></tr><tr><td><a href="http://standards.ieee.org/about/get/802/802.1.html" target="_blank" rel="noopener noreferrer">IEEE 802.1ad</a></td><td>IEEE Standards for Local and Metropolitan Area Networks : Virtual Bridged Local Area Networks- Amendment 4</td></tr></tbody></table>`,6))])}const f=i(u,[["render",g]]),y=JSON.parse('{"path":"/posts/Collection/%E6%8A%A5%E6%96%87%E6%A0%BC%E5%BC%8F/%E6%95%B0%E6%8D%AE%E9%93%BE%E8%B7%AF%E5%B1%82/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.html","title":"【转载】QinQ 帧格式","lang":"zh-CN","frontmatter":{"title":"【转载】QinQ 帧格式","shortTitle":"QinQ 帧格式","description":"QinQ 帧格式","icon":"/assets/blogicons/协议.png","author":"昌霖学长","isOriginal":false,"date":"2024-08-01T00:00:00.000Z","categories":["网络协议"],"tags":["QinQ","VLAN","帧格式"],"license":"MIT","sticky":false,"star":false,"article":true,"timeline":true,"comment":false,"head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"【转载】QinQ 帧格式\\",\\"image\\":[\\"https://shawnlyu1990.github.io/assets/postsimages/2024-08-01-QinQ帧格式/QinQ帧格式.jpeg\\"],\\"datePublished\\":\\"2024-08-01T00:00:00.000Z\\",\\"dateModified\\":\\"2025-02-11T09:39:41.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"昌霖学长\\"}]}"],["meta",{"property":"og:url","content":"https://shawnlyu1990.github.io/posts/Collection/%E6%8A%A5%E6%96%87%E6%A0%BC%E5%BC%8F/%E6%95%B0%E6%8D%AE%E9%93%BE%E8%B7%AF%E5%B1%82/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.html"}],["meta",{"property":"og:site_name","content":"昌霖学长的自习室"}],["meta",{"property":"og:title","content":"【转载】QinQ 帧格式"}],["meta",{"property":"og:description","content":"QinQ 帧格式"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://shawnlyu1990.github.io/assets/postsimages/2024-08-01-QinQ帧格式/QinQ帧格式.jpeg"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-02-11T09:39:41.000Z"}],["meta",{"property":"article:author","content":"昌霖学长"}],["meta",{"property":"article:tag","content":"帧格式"}],["meta",{"property":"article:tag","content":"VLAN"}],["meta",{"property":"article:tag","content":"QinQ"}],["meta",{"property":"article:published_time","content":"2024-08-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2025-02-11T09:39:41.000Z"}]]},"git":{"createdTime":1724140359000,"updatedTime":1739266781000,"contributors":[{"name":"Shawn Lyu","username":"","email":"shawnlyu1990@gmail.com","commits":8}]},"readingTime":{"minutes":8.05,"words":2416},"filePathRelative":"posts/Collection/报文格式/数据链路层/2024-08-01-QinQ帧格式.md","excerpt":"","copyright":{"license":"MIT"}}');export{f as comp,y as data};
