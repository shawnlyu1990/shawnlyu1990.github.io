import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as r,d as p,a as s,e as a,b as t,w as l,r as o,o as d}from"./app-BICfmULO.js";const g="/assets/postsimages/2024-08-01-VLAN%E5%B8%A7%E6%A0%BC%E5%BC%8F/VLAN%E5%B8%A7%E6%A0%BC%E5%BC%8F.jpeg",c={};function u(E,n){const e=o("font");return d(),r("div",null,[n[38]||(n[38]=p('<div class="hint-container important"><p class="hint-container-title">转载声明</p><p>以下内容转载自：<a href="https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/75653f56" target="_blank" rel="noopener noreferrer">https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/75653f56</a></p></div><p>IEEE 802.1Q 标准对以太帧格式进行了修改，在源 MAC 地址字段和协议类型字段之间加入 4 字节的 802.1Q Tag。802.1Q Tag 也称为 VLAN Tag，带有 VLAN Tag 的以太帧称为 VLAN 帧。</p><h2 id="帧格式" tabindex="-1"><a class="header-anchor" href="#帧格式"><span>帧格式</span></a></h2><figure><img src="'+g+'" alt="VLAN 帧格式" tabindex="0" loading="lazy"><figcaption>VLAN 帧格式</figcaption></figure><p>VLAN帧的链路层各字段含义</p>',5)),s("table",null,[n[37]||(n[37]=s("thead",null,[s("tr",null,[s("th",{style:{"text-align":"center"}},[s("div",{style:{width:"80px"}},"字段")]),s("th",{style:{"text-align":"center"}},[s("div",{style:{width:"120px"}},"长度")]),s("th",null,"含义")])],-1)),s("tbody",null,[n[31]||(n[31]=s("tr",null,[s("td",{style:{"text-align":"center"}},"DMAC"),s("td",{style:{"text-align":"center"}},"6 字节"),s("td",null,"目的 MAC 地址，该字段标识帧的接收者。")],-1)),n[32]||(n[32]=s("tr",null,[s("td",{style:{"text-align":"center"}},"SMAC"),s("td",{style:{"text-align":"center"}},"6 字节"),s("td",null,"源 MAC 地址，该字段标识帧的发送者。")],-1)),s("tr",null,[n[6]||(n[6]=s("td",{style:{"text-align":"center"}},"TPID/ETPE",-1)),n[7]||(n[7]=s("td",{style:{"text-align":"center"}},"2 字节",-1)),s("td",null,[n[1]||(n[1]=a("TPID（Tag Protocol Identifier，标签协议标识）表示帧类型。")),n[2]||(n[2]=s("br",null,null,-1)),n[3]||(n[3]=a()),n[4]||(n[4]=s("br",null,null,-1)),n[5]||(n[5]=a()),t(e,{color:"darkred"},{default:l(()=>n[0]||(n[0]=[s("b",null,[a("说明："),s("br"),a(),s("br"),a("根据 IEEE 802.1Q 标准的定义，取值为 0x8100 时表示 802.1Q Tag（VLAN） 帧。如果不支持 802.1Q 的设备收到这样的帧，会将其丢弃。"),s("br"),a(),s("br"),a("根据 IEEE 802.1ad 的定义，802.1Q Tag 可分为 S-Tag 和 C-Tag 两种，S-Tag 用于标识业务，C-Tag 用于标识用户。区分这两种 Tag 的是 TPID，S-Tag 的 TPID 是 0x88a8，C-Tag 的 TPID 是 0x8100。"),s("br"),a(),s("br"),a("MEF 26.1（ENNI Specification） 标准中规定出 ENNI 端口的 VLAN 帧的Tag 可以是 S-Tag。可见，VLAN 帧的 TPID 值可以是非 0x8100。")],-1)])),_:1})])]),n[33]||(n[33]=s("tr",null,[s("td",{style:{"text-align":"center"}},"PRI"),s("td",{style:{"text-align":"center"}},"3 比特"),s("td",null,"PRI（Priority） 表示帧的 QoS 优先级，取值范围为 0～7，值越大优先级越高，该优先级主要为 QoS 差分服务提供参考依据。当阻塞时，优先发送优先级高的数据包。如果设置用户优先级，但是没有 VID（VLAN ID），则 VLAN ID 必须设置为 0x000。")],-1)),s("tr",null,[n[17]||(n[17]=s("td",{style:{"text-align":"center"}},"CFI/DEI",-1)),n[18]||(n[18]=s("td",{style:{"text-align":"center"}},"1 比特",-1)),s("td",null,[n[9]||(n[9]=a("CFI (Canonical Format Indicator，标准格式指示)，长度为 1 比特，表示MAC 地址是否是标准格式。CFI 为 0 说明是标准格式（以太网帧的 MAC 地址采用低字节在前），CFI 为 1 表示为非标准格式（非以太网帧的 MAC 地址采用高字节在前）。CFI 可用于区分以太网帧、FDDI（Fiber Distributed Digital Interface）帧和令牌环网帧。在以太网中，CFI 的值为 0。")),n[10]||(n[10]=s("br",null,null,-1)),n[11]||(n[11]=a()),n[12]||(n[12]=s("br",null,null,-1)),n[13]||(n[13]=a(" DEI（Drop Eligible Indicator，丢弃优先级指示），配合 PRI 字段使用，共同指示帧的丢弃优先级，也就是系统发生了拥塞时，这些报文会被优先丢弃。 ")),n[14]||(n[14]=s("br",null,null,-1)),n[15]||(n[15]=a()),n[16]||(n[16]=s("br",null,null,-1)),t(e,{color:"darkred"},{default:l(()=>n[8]||(n[8]=[s("b",null,[a("说明："),s("br"),a(),s("br"),a("IEEE 802.1Q 定义了 CFI 字段，而 IEEE 802.1ad 标准重新定义了 CFI 字段，规定 S-Tag 里面的是 DEI，C-Tag 里面的是 CFI。"),s("br"),a(),s("br"),a("实际应用中，可以根据需要将此比特位用作 CFI 或者用作 DEI。")],-1)])),_:1})])]),n[34]||(n[34]=s("tr",null,[s("td",{style:{"text-align":"center"}},"VID"),s("td",{style:{"text-align":"center"}},"12 比特"),s("td",null,[a("VID（VLAN ID），长度为 12 比特，表示该帧所属的 VLAN。在 VRP 中，可配置的 VLAN ID 取值范围为 1～4094。协议规定 0 和 4095 为保留的 VLAN ID。"),s("br"),a(),s("br"),a("有三种 VID 类型："),s("li",null,"Untagged 帧：VID 不计"),s("li",null,"Priority-tagged 帧：VID 为 0x000"),s("li",null,"VLAN-tagged 帧：VID 范围 0～4095"),s("br"),a("三个特殊的 VID："),s("li",null,"0x000：设置优先级但无 VID"),s("li",null,"0x001：缺省 VID"),s("li",null,"0xFFF：预留 VID")])],-1)),n[35]||(n[35]=s("tr",null,[s("td",{style:{"text-align":"center"}},"Length/Type"),s("td",{style:{"text-align":"center"}},"2 字节"),s("td",null,[a("该字段有两种含义："),s("li",null,"Length：如果该字段值小于或等于十进制 1500（或十六进制0x05DC）时，该字段指后续数据的字节长度，但不包括 FCS 字段。"),s("li",null,"Type：如果该字段值大于或等于十进制 1536（或十六进制0x0600）时，该字段指链路直接封装的上层协议类型。")])],-1)),s("tr",null,[n[29]||(n[29]=s("td",{style:{"text-align":"center"}},"Data",-1)),n[30]||(n[30]=s("td",{style:{"text-align":"center"}},"42～1500 字节",-1)),s("td",null,[n[20]||(n[20]=a("负载（可能包含填充位）。")),n[21]||(n[21]=s("br",null,null,-1)),n[22]||(n[22]=a()),n[23]||(n[23]=s("br",null,null,-1)),n[24]||(n[24]=a("VLAN帧的长度必须为整数字节，因此帧的负载长度不足整数字节，需插入填充字段以保证数据帧的长度为整数字节。")),n[25]||(n[25]=s("br",null,null,-1)),n[26]||(n[26]=a()),n[27]||(n[27]=s("br",null,null,-1)),n[28]||(n[28]=a()),t(e,{color:"darkred"},{default:l(()=>n[19]||(n[19]=[s("b",null,[a("说明："),s("br"),a("IEEE 802.1Q 和 IEEE 802.1ad 标准中并没有定义 VLAN 帧的最小长度和最大长度。各厂商可能存在实现差异导致该字段长度不同。")],-1)])),_:1})])]),n[36]||(n[36]=s("tr",null,[s("td",{style:{"text-align":"center"}},"FCS"),s("td",{style:{"text-align":"center"}},"4 字节"),s("td",null,"帧校验序列 FCS（Frame Check Sequence） 是为接收网卡提供判断是否传输错误的一种方法，如果发现错误，丢弃此帧。FCS 只是通用叫法，具体的 FCS 还可以细分多种校验方法。在以太帧中，FCS 通常采用循环冗余码校验 CRC（Cyclical Redundancy Check）。")],-1))])]),n[39]||(n[39]=p(`<p>VLAN帧的物理层各字段含义</p><table><thead><tr><th style="text-align:center;"><div style="width:80px;">字段</div></th><th style="text-align:center;"><div style="width:120px;">长度</div></th><th>含义</th></tr></thead><tbody><tr><td style="text-align:center;">帧间隙</td><td style="text-align:center;">至少 12 字节</td><td>每个以太帧之间都要有帧间隙（Inter Frame Gap），即每发完一个帧后要等待一段时间才能再发另外一个帧，以便让帧接收者对接收的帧做必要的处理（如调整缓存的指针、更新计数、通知对报文进行处理等等）。<br> <br>在以太网标准中规定最小帧间隙是 12 个字节，其数据为全1。对于个别的接口，可减少到 64(GE) 或 40 比特 (10GE)，其他的接口都不应该小于 12 字节。</td></tr><tr><td style="text-align:center;">前同步码</td><td style="text-align:center;">7 字节</td><td>以太网标准中规定前导码为10101010 10101010 10101010 10101010 10101010 10101010 10101010（二进制），共7字节。</td></tr><tr><td style="text-align:center;">帧开始定界符</td><td style="text-align:center;">1 字节</td><td>以太网标准中规定帧开始定界符为 10101011（二进制），共1字节。</td></tr></tbody></table><h2 id="帧示例" tabindex="-1"><a class="header-anchor" href="#帧示例"><span>帧示例</span></a></h2><div class="language-text has-collapsed-lines collapsed" data-highlighter="shiki" data-ext="text" style="--vp-collapsed-lines:15;--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>Frame 1: 114 bytes on wire (912 bits), 114 bytes captured (912 bits)</span></span>
