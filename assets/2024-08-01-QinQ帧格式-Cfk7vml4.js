import{a as e,d as t,i as n,l as r,n as i,o as a,s as o,t as s,u as c}from"./app-pSnCdMtf.js";var l=JSON.parse(`{"path":"/posts/Collection/%E6%8A%A5%E6%96%87%E6%A0%BC%E5%BC%8F/%E6%95%B0%E6%8D%AE%E9%93%BE%E8%B7%AF%E5%B1%82/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.html","title":"【转载】QinQ 帧格式","lang":"zh-CN","frontmatter":{"title":"【转载】QinQ 帧格式","shortTitle":"QinQ 帧格式","description":"QinQ 帧格式","icon":"/assets/blogicons/协议.png","author":"昌霖学长","isOriginal":false,"date":"2024-08-01T00:00:00.000Z","categories":["网络协议"],"tags":["QinQ","VLAN","帧格式"],"license":"MIT","sticky":false,"star":false,"article":true,"timeline":true,"comment":false,"head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"【转载】QinQ 帧格式\\",\\"image\\":[\\"https://mrcharlin.com/assets/postsimages/2024-08-01-QinQ帧格式/QinQ帧格式.jpeg\\"],\\"datePublished\\":\\"2024-08-01T00:00:00.000Z\\",\\"dateModified\\":\\"2026-09-11T03:13:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"昌霖学长\\"}]}"],["meta",{"property":"og:url","content":"https://mrcharlin.com/posts/Collection/%E6%8A%A5%E6%96%87%E6%A0%BC%E5%BC%8F/%E6%95%B0%E6%8D%AE%E9%93%BE%E8%B7%AF%E5%B1%82/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.html"}],["meta",{"property":"og:site_name","content":"昌霖学长的自习室"}],["meta",{"property":"og:title","content":"【转载】QinQ 帧格式"}],["meta",{"property":"og:description","content":"QinQ 帧格式"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://mrcharlin.com/assets/postsimages/2024-08-01-QinQ帧格式/QinQ帧格式.jpeg"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-09-11T03:13:37.000Z"}],["meta",{"property":"article:author","content":"昌霖学长"}],["meta",{"property":"article:tag","content":"帧格式"}],["meta",{"property":"article:tag","content":"VLAN"}],["meta",{"property":"article:tag","content":"QinQ"}],["meta",{"property":"article:published_time","content":"2024-08-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2026-09-11T03:13:37.000Z"}]]},"git":{"createdTime":1724140359000,"updatedTime":1789096417000,"contributors":[{"name":"Shawn Lyu","username":"","email":"shawnlyu1990@gmail.com","commits":11}]},"readingTime":{"minutes":8.07,"words":2421},"filePathRelative":"posts/Collection/报文格式/数据链路层/2024-08-01-QinQ帧格式.md","excerpt":"<div class=\\"hint-container important\\">\\n<p class=\\"hint-container-title\\">转载声明</p>\\n<p>以下内容转载自：<a href=\\"https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e</a></p>\\n</div>\\n<p>QinQ 是对 802.1Q（VLAN） 的扩展，其核心思想是将用户私网 VLAN tag 封装到公网 VLAN tag 中，报文带着两层 tag 穿越服务商的骨干网络，从而为用户提供一种较为简单的二层 VPN 隧道。QinQ 报文有固定的格式，就是在 802.1Q 的标签之上再打一层 802.1Q 标签，QinQ 报文比 802.1Q（VLAN） 报文多 4 字节。</p>"}`),u={name:`2024-08-01-QinQ帧格式.md`};function d(s,l,u,d,f,p){let m=c(`font`);return r(),n(`div`,null,[l[30]||=e(`<div class="hint-container important"><p class="hint-container-title">转载声明</p><p>以下内容转载自：<a href="https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e" target="_blank" rel="noopener noreferrer">https://support.huawei.com/enterprise/zh/doc/EDOC1100174722/e4e9d43e</a></p></div><p>QinQ 是对 802.1Q（VLAN） 的扩展，其核心思想是将用户私网 VLAN tag 封装到公网 VLAN tag 中，报文带着两层 tag 穿越服务商的骨干网络，从而为用户提供一种较为简单的二层 VPN 隧道。QinQ 报文有固定的格式，就是在 802.1Q 的标签之上再打一层 802.1Q 标签，QinQ 报文比 802.1Q（VLAN） 报文多 4 字节。</p><h2 id="帧格式" tabindex="-1"><a class="header-anchor" href="#帧格式"><span>帧格式</span></a></h2><figure><img src="/assets/postsimages/2024-08-01-QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F/QinQ%E5%B8%A7%E6%A0%BC%E5%BC%8F.jpeg" alt="QinQ 帧格式" tabindex="0" loading="lazy"><figcaption>QinQ 帧格式</figcaption></figure><p>QinQ帧的链路层各字段含义</p>`,5),i(`table`,null,[l[29]||=i(`thead`,null,[i(`tr`,null,[i(`th`,{style:{"text-align":`center`}},[i(`div`,{style:{width:`80px`}},`字段`)]),i(`th`,{style:{"text-align":`center`}},[i(`div`,{style:{width:`120px`}},`长度`)]),i(`th`,null,`含义`)])],-1),i(`tbody`,null,[l[22]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`DMAC`),i(`td`,{style:{"text-align":`center`}},`6 字节`),i(`td`,null,`目的 MAC 地址，该字段标识帧的接收者。`)],-1),l[23]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`SMAC`),i(`td`,{style:{"text-align":`center`}},`6 字节`),i(`td`,null,`源 MAC 地址，该字段标识帧的发送者。`)],-1),l[24]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`TPID/ETPE`),i(`td`,{style:{"text-align":`center`}},`2 字节`),i(`td`,null,[a(`TPID（Tag Protocol Identifier，标签协议标识）表示帧类型。取值为 0x8100 时表示 802.1Q Tag 帧。如果不支持 802.1Q 的设备收到这样的帧，会将其丢弃。`),i(`br`),a(),i(`br`),a(`对于内层的 802.1Q Tag，该值设置为 0x8100；对于外层的 802.1Q Tag，不同厂商所使用的值可能不相同：`),i(`ul`,null,[i(`li`,null,`0x8100：Huawei 路由器使用`),a(),i(`li`,null,`0x88A8：Extreme Networks 交换机使用 (该值在 IEEE 802.1ad 定义.)`),a(),i(`li`,null,`0x9100：Juniper 路由器使用`),a(),i(`li`,null,`0x9200：Several 路由器使用`)]),a(` 在使用 VRP®（Versatile Routing Platform）软件的华为设备上，外层 802.1Q Tag 缺省情况下值为 0x8100，可以通过命令行调整该值。`)])],-1),l[25]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`PRI`),i(`td`,{style:{"text-align":`center`}},`3 比特`),i(`td`,null,`PRI（Priority） 表示帧的 QoS 优先级，取值范围为 0～7，值越大优先级越高，该优先级主要为 QoS 差分服务提供参考依据。当阻塞时，优先发送优先级高的数据包。如果设置用户优先级，但是没有 VID（VLAN ID），则 VLAN ID 必须设置为 0x000。`)],-1),i(`tr`,null,[l[9]||=i(`td`,{style:{"text-align":`center`}},`CFI/DEI`,-1),l[10]||=i(`td`,{style:{"text-align":`center`}},`1 比特`,-1),i(`td`,null,[l[1]||=a(`CFI (Canonical Format Indicator，标准格式指示)，长度为 1 比特，表示MAC 地址是否是标准格式。CFI 为 0 说明是标准格式（以太网帧的 MAC 地址采用低字节在前），CFI 为 1 表示为非标准格式（非以太网帧的 MAC 地址采用高字节在前）。CFI 可用于区分以太网帧、FDDI（Fiber Distributed Digital Interface）帧和令牌环网帧。在以太网中，CFI 的值为 0。`,-1),l[2]||=i(`br`,null,null,-1),l[3]||=a(),l[4]||=i(`br`,null,null,-1),l[5]||=a(`DEI（Drop Eligible Indicator，丢弃优先级指示），配合 PRI 字段使用，共同指示帧的丢弃优先级，也就是系统发生了拥塞时，这些报文会被优先丢弃。`,-1),l[6]||=i(`br`,null,null,-1),l[7]||=a(),l[8]||=i(`br`,null,null,-1),o(m,{color:`darkred`},{default:t(()=>[...l[0]||=[i(`b`,null,[a(`说明：`),i(`br`),a(),i(`br`),a(`IEEE 802.1Q 定义了 CFI 字段，而 IEEE 802.1ad 标准重新定义了 CFI 字段，规定 S-Tag 里面的是 DEI，C-Tag 里面的是 CFI。`),i(`br`),a(),i(`br`),a(`实际应用中，可以根据需要将此比特位用作 CFI 或者用作 DEI。`)],-1)]]),_:1})])]),l[26]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`VID`),i(`td`,{style:{"text-align":`center`}},`12 比特`),i(`td`,null,[a(`VID（VLAN ID），长度为 12 比特，表示该帧所属的 VLAN。在 VRP 中，可配置的 VLAN ID 取值范围为 1～4094。协议规定 0 和 4095 为保留的 VLAN ID。`),i(`br`),a(),i(`br`),a(`有三种 VID 类型：`),i(`ul`,null,[i(`li`,null,`Untagged 帧：VID 不计`),i(`li`,null,`Priority-tagged 帧：VID 为 0x000`),i(`li`,null,`VLAN-tagged 帧：VID 范围 0～4095`)]),a(`三个特殊的 VID：`),i(`ul`,null,[i(`li`,null,`0x000：设置优先级但无 VID`),i(`li`,null,`0x001：缺省 VID`),i(`li`,null,`0xFFF：预留 VID`)])])],-1),l[27]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`Length/Type`),i(`td`,{style:{"text-align":`center`}},`2 字节`),i(`td`,null,[a(`该字段有两种含义：`),i(`ul`,null,[i(`li`,null,`Length：如果该字段值小于或等于十进制 1500（或十六进制 0x05DC）时，该字段指后续数据的字节长度，但不包括 FCS 字段。`),i(`li`,null,`Type：如果该字段值大于或等于十进制 1536（或十六进制 0x0600）时，该字段指链路直接封装的上层协议类型。`)])])],-1),i(`tr`,null,[l[20]||=i(`td`,{style:{"text-align":`center`}},`Data`,-1),l[21]||=i(`td`,{style:{"text-align":`center`}},`38～1500 字节`,-1),i(`td`,null,[l[12]||=a(`负载（可能包含填充位）。`,-1),l[13]||=i(`br`,null,null,-1),l[14]||=a(),l[15]||=i(`br`,null,null,-1),l[16]||=a(`VLAN 帧的长度必须为整数字节，因此帧的负载长度不足整数字节，需插入填充字段以保证数据帧的长度为整数字节。`,-1),l[17]||=i(`br`,null,null,-1),l[18]||=a(),l[19]||=i(`br`,null,null,-1),o(m,{color:`darkred`},{default:t(()=>[...l[11]||=[i(`b`,null,[a(`说明：`),i(`br`),a(),i(`br`),a(`IEEE 802.1Q 和 IEEE 802.1ad 标准中并没有定义 VLAN 帧的最小长度和最大长度。各厂商可能存在实现差异导致该字段长度不同。`)],-1)]]),_:1})])]),l[28]||=i(`tr`,null,[i(`td`,{style:{"text-align":`center`}},`FCS`),i(`td`,{style:{"text-align":`center`}},`4 字节`),i(`td`,null,`帧校验序列 FCS（Frame Check Sequence） 是为接收网卡提供判断是否传输错误的一种方法，如果发现错误，丢弃此帧。FCS 只是通用叫法，具体的 FCS 还可以细分多种校验方法。在以太帧中，FCS 通常采用循环冗余码校验 CRC（Cyclical Redundancy Check）。`)],-1)])]),l[31]||=e(`<p>VLAN帧的物理层各字段含义</p><table><thead><tr><th style="text-align:center;"><div style="width:80px;">字段</div></th><th style="text-align:center;"><div style="width:120px;">长度</div></th><th>含义</th></tr></thead><tbody><tr><td style="text-align:center;">帧间隙</td><td style="text-align:center;">至少 12 字节</td><td>每个以太帧之间都要有帧间隙（Inter Frame Gap），即每发完一个帧后要等待一段时间才能再发另外一个帧，以便让帧接收者对接收的帧做必要的处理（如调整缓存的指针、更新计数、通知对报文进行处理等等）。<br> <br>在以太网标准中规定最小帧间隙是 12 个字节，其数据为全 1。对于个别的接口，可减少到 64 (GE) 或 40 比特 (10 GE)，其他的接口都不应该小于 12 字节。</td></tr><tr><td style="text-align:center;">前同步码</td><td style="text-align:center;">7 字节</td><td>以太网标准中规定前导码为 10101010 10101010 10101010 10101010 10101010 10101010 10101010（二进制），共 7 字节。</td></tr><tr><td style="text-align:center;">帧开始定界符</td><td style="text-align:center;">1 字节</td><td>以太网标准中规定帧开始定界符为 10101011（二进制），共 1 字节。</td></tr></tbody></table><h2 id="帧示例" tabindex="-1"><a class="header-anchor" href="#帧示例"><span>帧示例</span></a></h2><div class="language-text has-collapsed-lines collapsed" data-highlighter="shiki" data-ext="text" style="--vp-collapsed-lines:15;background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-text"><span class="line"><span>Frame 1: 391 bytes on wire (3128 bits), 391 bytes captured (3128 bits)</span></span>
